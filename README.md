...
<h5>batch-learn-laravel di build menggunakan framework laravel versi 11, jadi pastikan versi php anda sudah diatas versi >8.1, (framework laravel adalah salah satu framwork dari bahasa pemrograman php) untuk membangun aplikasi berbasis web</h5>
